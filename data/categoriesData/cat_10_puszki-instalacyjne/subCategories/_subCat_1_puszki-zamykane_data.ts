...
const puszkiZamykane_productCard_data: IF_ProductCardData[] = [
  ...
  {
    arrayIndex: 31,
    path: `${catalogStructureData[9].subCategoriesUrls[0]}/model-3092`,
  ...
  {
    arrayIndex: 32,
    path: `${catalogStructureData[9].subCategoriesUrls[0]}/model-3084`,
    textIcons: ['IP55', 'Wymiary: 135 × 160 × 83 (w/s/g)'],
  ...
  {
    arrayIndex: 33,
    path: `${catalogStructureData[9].subCategoriesUrls[0]}/model-3085`,
    textIcons: ['IP55', 'Wymiary: 135 × 160 × 83 (w/s/g)'],
  ...
  {
    arrayIndex: 34,
    path: `${catalogStructureData[9].subCategoriesUrls[0]}/model-3086`,
    textIcons: ['IP55', 'Wymiary: 135 × 160 × 83 (w/s/g)'],

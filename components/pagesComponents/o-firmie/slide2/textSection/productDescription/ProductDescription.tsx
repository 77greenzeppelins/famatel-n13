...
const ProductDescription = () => {
  return (
    <div className="relative flex flex-col justify-end items-start xl:justify-center sm:items-end sm:justify-start inner-px sm:inner-px-md pt-[62px] lg:pt-[88px] sm:pb-16 lg:pb-0 w-full h-full ">
      ...
      <div className="absolute inset-0 bg-dark opacity-75 pointer-events-none" />
    </div>
  );
};

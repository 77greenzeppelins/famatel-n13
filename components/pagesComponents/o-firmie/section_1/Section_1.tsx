...
const Section_1: React.FunctionComponent<{
  ...
  return (
    ...
    >
      ...
      <div
        className="relative flex items-center w-full inner-pl-md-lg pt-[62px] xs:pt-[120px] md:pt-[120px] lg:pt-[160px] xl:flex-col xl:justify-center xl:gap-y-4 xl:pt-30 xl:w-[45%] xxl:w-[40%] h-full "
        //___xl:h-screen
      >
        <TextSection />

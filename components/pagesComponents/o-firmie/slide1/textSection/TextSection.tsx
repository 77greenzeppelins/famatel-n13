...
// const xlStyle = 'xl:justify-center';
...
const TextSection = () => {
  ...
  return (
    <div
      // className="flex flex-col justify-end items-start sm:items-end sm:justify-start inner-px sm:inner-px-md pt-[62px] lg:pt-[88px] xl:pt-[128px] sm:pb-16 lg:pb-0 w-full h-full"

      className="flex flex-col justify-end items-start xl:justify-center sm:items-end sm:justify-start inner-px sm:inner-px-md pt-[62px] lg:pt-[88px] sm:pb-16 lg:pb-0 w-full h-full"
    >

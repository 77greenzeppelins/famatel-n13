...
const SvgTechSection = () => {
  /*
  Trick: how to make svg responsive; "SVGModule__container" inherits width and height from some parent; is pluged to useMeasure; value from hooks is propsed to SVG
  */
  ...
  return (
    ...
    >
      <div className="fc w-full h-full">
        <SvgTechMetalowe basicSize={bounds.width * 0.9} />
      </div>
    </div>
  );
};

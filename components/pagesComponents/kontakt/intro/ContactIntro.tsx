...
/**Hardcoded Staff*/
const witajStyle =
  'text-light text-8xl lg:text-9xl font-bold tracking-[1.5px] lg:tracking-[1.5px] word-spacing-0125 lg:word-spacing-025 disable-soft';
  ...
  return (
    <SectionContentLayout divStyle="flex flex-col gap-y-4 md:flex-row md:gap-x-14 pt-[20px]">
      ...
      <div className="flex items-center lg:w-[70%] xl:w-[50%]">
        <p className="text-1rem lg:text-2xl text-grey text-center md:text-left tracking-[1.5px] lg:tracking-[2px] word-spacing-0125 lg:word-spacing-025 disable-soft">

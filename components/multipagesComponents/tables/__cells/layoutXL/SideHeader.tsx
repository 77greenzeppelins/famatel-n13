...
const SideHeader: React.FunctionComponent<{
  ...
  return (
    ...
    >
      <p
        className={`text-left text-[0.75rem] xs:text-[0.75rem] lg:text-[0.75rem] xxl:text-[0.75rem] tracking-[1px] lg:tracking-[0.125rem] word-spacing-01 lg:word-spacing-0125 select-none break-all ${

...
const SvgMap = ({ containerStyle }: { containerStyle?: string }) => {
  return (
    ...
    >
      ...
      <g fill="#666" transform="translate(9.5 8.487) scale(1.8431)">
      ...
      <text
        ...
        textAnchor="middle"
      >
        <tspan x="191.262" y="344.282">
          Famatel
        </tspan>
        <tspan x="191.262" y="362.282">
          Polska
        </tspan>
      </text>
      <path
      ...
      >
        <path fill="#e74124" d="M-572.5 171.07H-340.36V216.427H-572.5z"></path>
        <path
          fill="none"
          strokeDasharray="1, 2"

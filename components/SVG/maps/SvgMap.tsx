    ...
    >
      <g>
        <path
          ...
          strokeWidth="2.182"
          d="M1.091 1.091H798.909V798.909H1.091z"
          stopColor="#000"
        ></path>
        ...
        <path
          ...
          strokeOpacity="1"
          strokeWidth="1"
          d="M800.019 75.194l-47.203 76.076-36.365 59.347-28.285 52.275-19.95 38.386-113.895-58.841-137.38-68.186-90.662-44.446-5.527 9.573 19.796 9.24 133.087 65.787 141.295 71.72 48.993 26.265-42.68 99.247-57.073 140.916-45.962 115.663-32.577 54.8-121.471-77.781-109.854-90.409-57.326-46.467-6.314 8.081 127.785 104.551 43.692 35.795 34.643 24.285L480 732.5 435.345 800l18.122.03.597-2.01 57.073-89.398 13.637-24.244 8.081-15.657 90.914-228.8 50.508-123.238 125.566 63.466.052-11.145-121.072-62.675 40.106-74.9 31.785-54.643 49.155-79.551z"
        ></path>
        <text
          xmlSpace="preserve"
          style={{
        ...
        <path
          ...
          strokeLinejoin="round"
          strokeWidth="0.358"
          d="M146.275 297.666l110.051 103.096c-23.11 32.901-44.142 67.13-65.41 101.226l-38.79-29.57 33.13-50.728-76.724-83.735z"
          stopColor="#000"
        ></path>
        <path
          fill="#e74124"
          ...
          strokeLinejoin="round"
          strokeWidth="0.358"
          d="M137.96 186.91L22.632 310.018l28.353 26.56 35.439 33.2 105.202 98.554 31.103-33.203-105.201-98.553 84.224-89.906z"
          stopColor="#000"
        ></path>
        <path
          fill="#fff"
          ...
          strokeOpacity="1"
          strokeWidth="1"
          d="M44.194 365.423l-8.586 8.08 93.186 92.682-44.446 53.791 8.586 6.566 43.69-52.78 46.466 36.87 8.334-9.596-55.558-42.427z"
        ></path>
        <text
          xmlSpace="preserve"
          style={{
        ...
        >
          <tspan x="287.745" y="279.976">
            Willowa
          </tspan>
        </text>
        <g fill="#666" transform="matrix(1.84312 0 0 1.84312 9.5 8.487)">
          <g fill="#666">
            ...
            <path d="M26.656 47.16l-1.606-.238c-.066-.01-.113-.027-.138-.061a.172.172 0 01-.039-.115c0-.073.04-.133.119-.178.079-.045.22-.066.42-.066.072 0 .146.006.22.018a.77.77 0 01.198.055.367.367 0 01.152.104.26.26 0 01.055.169H27.6a.999.999 0 00-.149-.479 1.016 1.016 0 00-.396-.348 2.305 2.305 0 00-.67-.215 5.456 5.456 0 00-.974-.074c-.277 0-.535.018-.775.051s-.448.092-.625.18a1.07 1.07 0 00-.417.345.93.93 0 00-.152.548c0 .12.018.233.053.338a.768.768 0 00.164.281c.075.082.172.153.288.213.117.059.259.102.426.127l1.535.229c.094.017.156.046.191.088a.224.224 0 01.053.143.234.234 0 01-.109.199c-.073.051-.215.076-.426.076-.207 0-.357-.023-.457-.07a.275.275 0 01-.144-.244h-1.621c0 .252.063.451.192.603.129.147.297.265.506.345.207.082.44.137.698.16.258.025.516.038.772.038.758 0 1.312-.099 1.662-.298.352-.198.526-.506.526-.924 0-.289-.097-.514-.29-.676-.192-.164-.46-.272-.805-.324z"></path>
        ...
        <text
          ...
          textAnchor="middle"
        >
          <tspan x="110.955" y="275.087">
            Famatel
          </tspan>
          <tspan x="110.955" y="293.087">
            Polska
          </tspan>
        </text>
        <g transform="matrix(.52467 0 0 .52467 364.68 116.595)">
          <g
            fill="#13b5c7"
            fillOpacity="1"
            transform="translate(533.626 266.228) scale(2.8895)"
          >
            <path
              fill="#13b5c7"
              fillOpacity="1"
          ...
          <path
            ...
            fillRule="evenodd"
            strokeWidth="0.359"
            d="M584.206 273.917l23.715 17.247v4.312h-4.312v23.714h4.312v4.312h-47.429v-4.312h4.312v-23.714h-4.312v-4.312zm15.091 17.247h-30.182v28.026h30.182zm-21.561 4.304l6.494 9.224 6.444-9.164v-.052h4.312v19.402h-4.312v-11.797l-6.444 10.298-6.495-10.242.004 11.741h-4.312v-19.402h4.312zm0 0"
          ></path>
        </g>
        <text
          xmlSpace="preserve"
        ...
        <g
          ...
          strokeLinejoin="round"
          strokeWidth="0.113"
          transform="rotate(-55.292 287.17 327.906)"
        >
          <path
            d="M294.039 247.616H308.366V249.917H294.039z"
            stopColor="#000"
          ></path>
          <path
            d="M316.01 247.616H330.337V249.917H316.01z"
            stopColor="#000"
          ></path>
          <path
            d="M340.001 247.616H354.328V249.917H340.001z"
            stopColor="#000"
          ></path>
          <path
            d="M361.972 247.616H376.299V249.917H361.972z"
            stopColor="#000"
          ></path>
          <path
            d="M385.983 247.616H400.31V249.917H385.983z"
            stopColor="#000"
          ></path>
          <path
            d="M407.954 247.616H422.281V249.917H407.954z"
            stopColor="#000"
          ></path>
          <path
            d="M431.945 247.616H446.272V249.917H431.945z"
            stopColor="#000"
          ></path>
          <path
            d="M453.916 247.616H468.243V249.917H453.916z"
            stopColor="#000"
          ></path>
          <path
            d="M202.039 247.616H216.36599999999999V249.917H202.039z"
            stopColor="#000"
          ></path>
          <path
            d="M224.01 247.616H238.337V249.917H224.01z"
            stopColor="#000"
          ></path>
          <path
            d="M248.001 247.616H262.32800000000003V249.917H248.001z"
            stopColor="#000"
          ></path>
          <path
            d="M269.972 247.616H284.299V249.917H269.972z"
            stopColor="#000"
          ></path>
        </g>
        <g
          ...
          strokeLinejoin="round"
          strokeWidth="0.113"
          transform="rotate(26.296 506.955 453.729)"
        >
          <path
            d="M294.039 247.616H308.366V249.917H294.039z"
            stopColor="#000"

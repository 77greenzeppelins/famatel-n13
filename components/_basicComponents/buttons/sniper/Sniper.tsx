...
const Sniper: React.FunctionComponent<{
  ...
  return (
    <div className="relative fc  w-full h-full group">
      <div
        className={`absolute top-0 left-0 h-[30%] w-[30%] border-t border-l ${
          color ? color : 'border-light'
        } opacity-60 group-hover:opacity-100 group-hover:h-[70%]  duration-[0.4s] ease-in delay-[0.2s]`}
      />
      <div
        className={`absolute bottom-0 left-0 h-[30%] w-[30%] border-b border-l ${
          color ? color : 'border-light'
        } opacity-60 group-hover:opacity-100 group-hover:w-[70%] duration-[0.4s] ease-in delay-[0.2s]`}
      />
      <div
        className={`absolute bottom-0 right-0 h-[30%] w-[30%] border-b border-r ${
          color ? color : 'border-light'
        } opacity-60 group-hover:opacity-100 group-hover:h-[70%] duration-[0.4s] ease-in delay-[0.2s]`}
      />
      <div
        className={`absolute top-0 right-0 h-[30%] w-[30%] border-t border-r ${
          color ? color : 'border-light'
        } opacity-60 group-hover:opacity-100 group-hover:w-[70%] duration-[0.4s] ease-in delay-[0.2s]`}
      />
    </div>
